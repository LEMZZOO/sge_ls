...
Despues de hacer la copia de seguridad, borramos todo el contenido de las carpetas
dataPG, sessions, filestore y addons.

Creo nuevamente los contenedores con `docker compose`, comprobamos que el servidor
no tenga datos y restauramos la copia de seguridad para comprobar que funciona.
...
`docker cp db:/backup.sql H:/SGE/OdooDesarrollo`
![Copia-Exitosa](image.png)

Ahora hacemos el paso inverso para restaurar la copia.
`docker cp H:/SGE/OdooDesarrollo db:/var/lib/postgresql/data`
